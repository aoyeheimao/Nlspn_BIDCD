...
class DFX802(BaseDataset):
    ...
    def __init__(self, args, mode):
        super(DFX802, self).__init__(args, mode)
        if self.mode == 'train':
            self.dir = '..'  # dir_path
            self.fold = 'data/mixedaispilt/train/*'
...
#
# for i in range(0,10):
#     dataset = DFX802(args_main,'train')[i]
#     # dataset = DFX802(args_main,'test')[i]

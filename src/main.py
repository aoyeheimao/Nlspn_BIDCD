...
def train(gpu, args):
    ...
    # frezze
    # net.freeze(net.conv1_rgb)
    # net.freeze(net.conv1_dep)
    # net.freeze(net.conv2)
    # net.freeze(net.conv3)
    # net.freeze(net.conv4)
    # net.freeze(net.conv5)
    # net.freeze(net.conv6)
    # net.freeze(net.dec5)
    # net.freeze(net.dec4)
    # net.freeze(net.dec3)
    # net.freeze(net.dec2)
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if gpu == 0:
            ...
            # if tmp_loss <= min_loss or epoch % 100 == 0:
            #     min_loss = tmp_loss
        ...
        if gpu == 0:
            ...
            if tmp_loss <= min_loss or epoch % 10 == 0:
                ...
                print("model with loss:", tmp_loss)
